...
class _$AdSettingsCopyWithImpl<$Res, $Val extends AdSettings>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      maxFailedLoadAttempts: freezed == maxFailedLoadAttempts
      ...
      rewardCupertino: freezed == rewardCupertino
          ...
          : rewardCupertino // ignore: cast_nullable_to_non_nullable
              as String?,
      updateLastAdsTime: freezed == updateLastAdsTime
...
class _$_AdSettings with DiagnosticableTreeMixin implements _AdSettings {
  _$_AdSettings(
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'AdSettings'))
      ..add(DiagnosticsProperty('maxFailedLoadAttempts', maxFailedLoadAttempts))
      ..add(DiagnosticsProperty('intersticialMaterial', intersticialMaterial))
      ..add(DiagnosticsProperty('intersticialCupertino', intersticialCupertino))
      ..add(DiagnosticsProperty('bannerMaterial', bannerMaterial))
      ..add(DiagnosticsProperty('bannerCupertino', bannerCupertino))
      ..add(DiagnosticsProperty('rewardMaterial', rewardMaterial))
      ..add(DiagnosticsProperty('rewardCupertino', rewardCupertino))
      ..add(DiagnosticsProperty('updateLastAdsTime', updateLastAdsTime));
  }
