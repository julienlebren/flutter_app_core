...
class GroupedListSectionTitle
  ...
  const GroupedListSectionTitle(this.title, {super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return ClipRRect(
      borderRadius: BorderRadius.only(
        ...
        topRight: isFirst ? const Radius.circular(10.0) : Radius.zero,
        bottomLeft: isLast ? const Radius.circular(10.0) : Radius.zero,
